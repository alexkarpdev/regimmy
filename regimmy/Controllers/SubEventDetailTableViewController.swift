    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .exercise:
            ...
            case nameCellRow:
                ...
                (cell as! EditFieldCell).configure(placeHolder: "Название", text: exercisePoso.name, tag: indexPath.row, fieldIsEnabled: isEditingMode) { t in
                    self.selectedPoso.name = t
                }
                cell.selectionStyle = .none
            case infoCellRow:
                cell = tableView.dequeueReusableCell(withIdentifier: EditFieldCell.identifier, for: indexPath)
                (cell as! EditFieldCell).configure(placeHolder: "Примечание", text: exercisePoso.info, tag: indexPath.row, fieldIsEnabled: isEditingMode, fontSize: 15) { t in
        ...
        case .ingredient:
            ...
            case 0:
                cell = tableView.dequeueReusableCell(withIdentifier: EditFieldCell.identifier, for: indexPath)
                (cell as! EditFieldCell).configure(placeHolder: "Название", text: ingredientPoso.name, tag: row, fieldIsEnabled: isEditingMode) { t in
                    self.selectedPoso.name = t
                }
            case 1:
                cell = tableView.dequeueReusableCell(withIdentifier: EditFieldCell.identifier, for: indexPath)
                (cell as! EditFieldCell).configure(placeHolder: "Примечание", text: ingredientPoso.info, tag: row, fieldIsEnabled: isEditingMode, fontSize: 15) { t in
                    self.selectedPoso.info = t
                }
            case 2:
                cell = tableView.dequeueReusableCell(withIdentifier: EditorNutrientCell.identifier, for: indexPath)
                (cell as! EditorNutrientCell).configure(name: "Белки", value: ingredientPoso.prot, unit: "грамм", color: #colorLiteral(red: 0.1058823529, green: 0.6784313725, blue: 0.9725490196, alpha: 1), tag: row, fieldIsEnabled: isEditingMode) { t in
                    ingredientPoso.prot = Double(t)!
                }
            case 3:
                cell = tableView.dequeueReusableCell(withIdentifier: EditorNutrientCell.identifier, for: indexPath)
                (cell as! EditorNutrientCell).configure(name: "Жиры", value: ingredientPoso.fat, unit: "грамм", color: #colorLiteral(red: 1, green: 0.8, blue: 0, alpha: 1), tag: row, fieldIsEnabled: isEditingMode) { t in
                    ingredientPoso.fat = Double(t)!
                }
            case 4:
                cell = tableView.dequeueReusableCell(withIdentifier: EditorNutrientCell.identifier, for: indexPath)
                (cell as! EditorNutrientCell).configure(name: "Углеводы", value: ingredientPoso.carb, unit: "грамм", color: #colorLiteral(red: 0.3882352941, green: 0.8549019608, blue: 0.2196078431, alpha: 1), tag: row, fieldIsEnabled: isEditingMode) { t in
                    ingredientPoso.carb = Double(t)!
                }
            case 5:
                cell = tableView.dequeueReusableCell(withIdentifier: EditorNutrientCell.identifier, for: indexPath)
                (cell as! EditorNutrientCell).configure(name: "Энерг.", value: ingredientPoso.cal, unit: "ккал.", color: #colorLiteral(red: 1, green: 0.5843137255, blue: 0, alpha: 1), tag: row, fieldIsEnabled: isEditingMode) { t in
        ...
        case .drug:
            ...
            case 0:
                cell = tableView.dequeueReusableCell(withIdentifier: EditFieldCell.identifier, for: indexPath)
                (cell as! EditFieldCell).configure(placeHolder: "Название", text: drugPoso.name, tag: row, fieldIsEnabled: isEditingMode) { t in
                    self.selectedPoso.name = t
                }
                cell.selectionStyle = .none
            case 1:
                cell = tableView.dequeueReusableCell(withIdentifier: EditFieldCell.identifier, for: indexPath)
                (cell as! EditFieldCell).configure(placeHolder: "Примечание", text: drugPoso.info, tag: row, fieldIsEnabled: isEditingMode, fontSize: 15) { t in
                    self.selectedPoso.info = t
                }
                cell.selectionStyle = .none
            case 2:
            ...
            case 3:
                cell = tableView.dequeueReusableCell(withIdentifier: EditorNutrientCell.identifier, for: indexPath)
                (cell as! EditorNutrientCell).configure(name: "Размер порции", value: drugPoso.servSize, unit: drugPoso.servUnit.rawValue, color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), tag: row, fieldIsEnabled: isEditingMode) { t in
